...
class SummaryDataModule3(pl.LightningDataModule):
    def __init__(self, args):
        ...
        if self.args.ch2en_mode == 'translate':
            if self.args.mode == 'train':
                data_files['train'] = 'dataset/en2zh/train_en2zh_tra_dataset.csv'
                data_files['val'] = 'dataset/en2zh/val_en2zh_tra_dataset.csv'
            data_files['test'] = 'dataset/en2zh/test_en2zh_tra_dataset.csv'
        elif self.args.ch2en_mode == 'cls_summary':
            if self.args.mode == 'train':
                data_files['train'] = 'dataset/en2zh/train_en2zh_cls_dataset.csv'
                data_files['val'] = 'dataset/en2zh/val_en2zh_cls_dataset.csv'
            data_files['test'] = 'dataset/en2zh/test_en2zh_cls_dataset.csv'
        elif self.args.ch2en_mode == 'dd_summary':
            if self.args.mode == 'train':
                data_files['train'] = 'dataset/en2zh/train_en2zhen_sum_dataset.csv'
                data_files['val'] = 'dataset/en2zh/val_en2zhen_sum_dataset.csv'
            data_files['test'] = 'dataset/en2zh/test_en2zhen_sum_dataset.csv'
    ...
    def collate_fn(self, data):
        if self.args.is_prompt:
            ...
            if self.args.ch2en_mode == 'dd_summary':
                refers = [d['tgt'].split('O.o')[0] for d in data]
                zh_refers = [d['tgt'].split('O.o')[1].lower() for d in data]
            elif self.args.ch2en_mode == 'summary' or self.args.tgt_lang == 'zh_CN':
                refers = [d['tgt'] if d['tgt'] is not None else '' for d in data]
            else:
