...
class SummaryDataModule2(pl.LightningDataModule):
    def __init__(self, args):
        ...
        if self.args.ch2en_mode == 'translate':
            if self.args.mode == 'train':
                data_files['train'] = 'dataset/vi2vizh/train_vi2zh_tra_dataset.csv'
                data_files['val'] = 'dataset/vi2vizh/val_vi2zh_tra_dataset.csv'
            data_files['test'] = 'dataset/vi2vizh/test_vi2zh_tra_dataset.csv'
        elif self.args.ch2en_mode == 'cls_summary':
            if self.args.mode == 'train':
                data_files['train'] = 'dataset/vi2vizh/train_vi2zh_cls_dataset.csv'
                data_files['val'] = 'dataset/vi2vizh/val_vi2zh_cls_dataset.csv'
            data_files['test'] = 'dataset/vi2vizh/test_vi2zh_cls_dataset.csv'
        elif self.args.ch2en_mode == 'dd_summary':
            if self.args.mode == 'train':
                data_files['train'] = 'dataset/vi2vizh/train_vi2vizh_sum_dataset.csv'
                data_files['val'] = 'dataset/vi2vizh/val_vi2vizh_sum_dataset.csv'
            data_files['test'] = 'dataset/vi2vizh/test_vi2vizh_sum_dataset.csv'
