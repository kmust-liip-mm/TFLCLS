...
class Seq2SeqModelOutput(ModelOutput):
    ...
    zh_last_hidden_state: torch.FloatTensor = None
    zh_past_key_values: Optional[Tuple[Tuple[torch.FloatTensor]]] = None
    zh_decoder_hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    zh_decoder_attentions: Optional[Tuple[torch.FloatTensor]] = None
    zh_cross_attentions: Optional[Tuple[torch.FloatTensor]] = None
